...
# # Create an instance of OperationTracker
# tracker = OperationTracker()

# # Generate unique operation IDs
# operation_id1 = tracker.generate_operation_id()
# operation_id2 = tracker.generate_operation_id()

# # Start and complete operations
# tracker.start_operation(operation_id1)
# tracker.complete_operation(operation_id1)

# # Check operation status
# print(f"Operation {operation_id1} status: {tracker.get_operation_status(operation_id1)}")
# print(f"Operation {operation_id2} status: {tracker.get_operation_status(operation_id2)}")
